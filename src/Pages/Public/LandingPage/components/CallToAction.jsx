...
export default function CallToAction() {
  ...
  <h3 className="text-2xl md:text-3xl font-black text-white mb-3">Order a Meal</h3>
  <p className="text-purple-50 leading-relaxed">Get restaurant-quality meals delivered fast. Schedule delivery or pick-up in minutes.</p>

        <div className="mt-6 flex flex-wrap gap-3">
          <a href="/order" className="inline-flex items-center gap-2 px-6 py-3 bg-white text-purple-600 rounded-full hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-xl font-bold">
            Order Now
